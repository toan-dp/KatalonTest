...
def static "com.example.WebUICustomKeywords.CheckEmailRegistered"(
    	String email	) {
    (new com.example.WebUICustomKeywords()).CheckEmailRegistered(
        	email)
}

def static "com.example.WebUICustomKeywords.CheckEmailValid"(
    	String email	) {
    (new com.example.WebUICustomKeywords()).CheckEmailValid(
        	email)
}

def static "com.example.WebUICustomKeywords.CheckInput"(
    	String email	) {
    (new com.example.WebUICustomKeywords()).CheckInput(
        	email)
}
